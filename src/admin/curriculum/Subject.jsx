			...
			<div className="row justify-content-center">
				<div className="col-lg-5">
					<div className="card shadow-lg border-0 rounded-lg mt-2">
						<div className="card-header"><h3 className="text-center font-weight-light my-4">Add New Subject</h3></div>
				...
				<div className="col-lg-7">
					<div className="card shadow-lg border-0 rounded-lg mt-2">
						<div className="card-header"><h3 className="text-center font-weight-light my-4">Your Subjects</h3></div>
						<div className="card-body">
							<Table responsive>
								<thead>
									<tr>
